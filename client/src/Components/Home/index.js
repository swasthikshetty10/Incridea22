      ...
      <div className="overflow-x-hidden relative  flex py-5 items-center justify-center flex-col-reverse md:flex-row tracking-wide" style={{ fontFamily: "CinzelDecorative-Bold" }}>
        ...
        <Slide direction="left" duration={1000}>
          <div className="flex gap-3 px-5 flex-col" >
            ...
            <p className="text-gray-100 font-body text-lg  text-justify" >An amalgamation of all forms of technical, literary and cultural activities. <i>Incridea</i> is a celebration of fervour and talent. It is the national level techno-cultural fest of
