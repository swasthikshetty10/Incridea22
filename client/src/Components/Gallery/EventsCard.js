...
function EventsCard({ name, src, desc }) {
    ...
    return (
        <>
            ...
            <div className="relative flex  flex-col mx-0 justify-center rounded-2xl shadow-xl hover:shadow-2xl  cursor-pointer transition ease-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 shadow-slate-300/60 hover:shadow-[#9d7643] "  >
