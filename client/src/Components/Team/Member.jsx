        ...
        <div className="transition-transform hover:scale-105 duration-300">
          ...
          <div className="text-center h-40 bg-[#1d1d1d]  p-2">
            ...
            <div className="flex justify-center gap-3 mb-2">
              <a href={`mailto:${email}`}>
                <HiOutlineMail className=" cursor-pointer text-igold hover:text-white  transition-all  ease-out text-2xl hover:text-3xl   " />
              </a>
              <a href={`tel:${mob}`}>
                <BsTelephoneOutbound className="   cursor-pointer text-igold hover:text-white transition-all  ease-out text-2xl hover:text-3xl  " />
              </a>
            </div>
          </div>
        </div>
