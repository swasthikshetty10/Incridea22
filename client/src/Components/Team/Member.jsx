...
const Member = ({ name, role, src }) => {
  return (
    <>
      <div className=" max-w-sm scale-90 lg:scale-100 h-full text-center w-[80%] lg:w-[22%] mt-2">
        <div className="transition-transform hover:scale-105 duration-300">
          ...
          <div className="text-center h-40 bg-[#1d1d1d]  p-2">
            ...
            <div className="flex justify-center gap-3 mb-2">
              ...
              <HiOutlineMail className="text-white cursor-pointer  transition ease-in-out  hover:text-lg hover:-translate-y-1  " />
              </a>
              <a href="tel:9649409088">
              <BsTelephoneOutbound className=" text-white cursor-pointer transition ease-in-out hover:translate-x-3 hover:text-lg hover:-translate-y-1 " />
              </a>
            </div>
          </div>
        </div>
