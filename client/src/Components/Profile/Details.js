        ...
        <>
            <div className="flex overflow-hidden  flex-col justify-center  py-8 bg-gray-900/30 ">
                ...
                <div className="flex justify-center pb-10 gap-x-5 ">
                    ...
                    <button type="button" className=" text-lg  font-semibold  text-[#9d7643] transition ease-in-out transition-duration-100  bg-[#000000] hover:bg-[#9d7643] backdrop-grayscale hover:text-white border-[#9d7643] border-2   rounded-none  px-3 py-2.5 text-center w-fit  my-2"
