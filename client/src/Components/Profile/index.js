  ...
  return (
    <div>
      <div className="text-lg lg:w-screen overflow-auto h-screen w-screen bg-[#000] m-auto flex flex-col items-center justify-center">
        ...
        <div className="border border-gray-400 mt-4 backdrop-blur-sm bg-white/1 rounded-lg shadow-2xl">
          <div className="border-l-4 border-purple-400 border-t-2 rounded-lg">
            <h1 className="text-2xl text-red-500 font-semibold">
              {participant.name}
            </h1>
            <h2 className=" text-gray-300">{participant.email}</h2>
            <div className="border-2 border-cyan-900 font-semibold text-cyan-200 rounded-md text-center inline">
              PID: {participant.pId}
            </div>
          </div>
          {/* <Second /> */}
          <div className=" m-auto flex-col sm:flex-row text-center flex-wrap flex justify-center">
            <div className="">
            ...
            <div className="sm:ml-10">
              ...
              <h2 className="text-gray-300">NMAMIT, Udupi</h2>
            </div>
            <div className="sm:ml-10">
              <h1 className="text-white">USN</h1>
              <h2 className="text-gray-300">4NM19IS181</h2>
            </div>
          </div>
          {/* <Third /> */}
          ...
          <div className="pt-8 text-sm space-x-5 flex justify-center">
            ...
            <button
              ...
              className="text-black hover:font-semibold bg-gradient-to-br transition-transform transform hover:scale-110 duration-200 from-cyan-300 to-blue-500 flex p-2 bg-white rounded-sm"
            >
