                                ...
                                <div>
                                    ...
                                    <div className={`text-center text-gray-400`}>
                                        ...
                                        <div className='flex justify-center text-sm '>
                                            <span className='inline-flex overflow-wrap  pr-2'>{day ? `1${parseInt(day) + 1}/05/2002` : "- "}</span> <span className='font-extrabold text-[#9d7643]'>|</span>
                                            <span className='inline-flex overflow-wrap  pl-2'> {time ? time : " -"}</span>
                                        </div>
                                    </div>
