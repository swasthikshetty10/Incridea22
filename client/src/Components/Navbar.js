            ...
            <nav className="bg-[#171717] px-2 sm:px-4 pt-6 ">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <button  type="button" class="text-white bg-[#DA0037] focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-none text-sm px-5 py-2.5 text-center mr-2 mb-2"> <Link to="/login" >Sign in</Link> </button>
                        ...
                        <button data-collapse-toggle="mobile-menu-4" type="button" onClick={handleHamburger} className={`  inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden `}    aria-controls="mobile-menu-4" aria-expanded="false">
